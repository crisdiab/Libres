aplicacion.controller('LoginCtrl', [
  ...
  function ($scope,$rootScope, $http ,$state,$cookies) {
    ...
    $scope.login = function () {
      ...
      $http({
        ...
        function (respuesta) {
          ...
          toastr.success("Bienvenido "+respuesta.data.user.nombre+ ' '+respuesta.data.user.apellido)
          window.location.href = masterUrl+"/app/index.html#/inicio";
    ...
    $scope.linkModelFunc = function(){
      $scope.linkModel = masterUrl+"/app/index.html#/inicio";
    }
